...
data_size_y = [0.072342, 0.051032, 0.037036, 0.045536]

numlay_x = [2, 3, 4]
numlay_y = [0.049285, 0.037737, 0.017513]

feat_x = [32, 64, 128]
feat_y = [0.049219, 0.039365, 0.032732]

lmax_x = [1, 2, 3]
lmax_y = [0.12291, 0.047852, 0.03928]
...
ax1.set_ylabel(r'$E_{\text{MAE}}^{\text{tot}}$ (eV)', fontsize=18)
...
ax3.set_ylabel(r'$E_{\text{MAE}}^{\text{tot}}$ (eV)', fontsize=18)
