...
5. Dataset preparation for the NMR-ML model:  
   ...
   ii. Dataset format for the NMR-ML model. ([directory](./matten-nmr-ml_dataset/))  
6. Training, validation, and testing processes for the NMR-ML model using MatTen architecture on NMR magnetic shielding parameters. ([directory](./matten-nmr-ml_model/))  
