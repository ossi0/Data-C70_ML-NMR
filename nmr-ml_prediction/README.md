...
```
- Note that this step can be included in the `script_predict.job` script (example found [here](./NMR-P!_monomer/0/script_predict.job)), if doing no parallel prediction calculations
